...
ALTER TABLE ac_absolved_concepts ADD CONSTRAINT ac_absolved_concepts_c_concept
    FOREIGN KEY (ac_c_concept)
    REFERENCES c_concept (c_id);

-- Reference: ac_absolved_concepts_us_user (table: ac_absolved_concepts)
ALTER TABLE ac_absolved_concepts ADD CONSTRAINT ac_absolved_concepts_us_user
