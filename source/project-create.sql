...
CREATE TABLE ac_absolved_concepts
(
    ac_id        NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
    ac_us_user   integer NOT NULL,
    ac_c_concept integer NOT NULL,
    CONSTRAINT ac_absolved_concepts_pk PRIMARY KEY (ac_id)
);

CREATE TABLE al_audit_log
(
    al_id   NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
    al_date timestamp          NOT NULL,
...
-- foreign keys
-- Reference: ac_absolved_concepts_c_concept (table: ac_absolved_concepts)
ALTER TABLE ac_absolved_concepts
    ADD CONSTRAINT ac_absolved_concepts_c_concept
        FOREIGN KEY (ac_c_concept)
            REFERENCES c_concept (c_id);

-- Reference: ac_absolved_concepts_us_user (table: ac_absolved_concepts)
ALTER TABLE ac_absolved_concepts
    ADD CONSTRAINT ac_absolved_concepts_us_user
        FOREIGN KEY (ac_us_user)
